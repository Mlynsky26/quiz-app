...
public static class SeedData
{
    public static void Seed(this WebApplication app)
    {
        using (var scope = app.Services.CreateScope())
        {
            ...
            q1.Add(quizItemRepo.Add(new QuizItem(1, "2+2", new List<string>(){"2", "3", "5"}, "4")));
            q1.Add(quizItemRepo.Add(new QuizItem(2, "3+2", new List<string>(){"4", "7", "9"}, "5")));
            q1.Add(quizItemRepo.Add(new QuizItem(3, "2-12", new List<string>(){"-2", "3", "15"}, "-10")));
            q1.Add(quizItemRepo.Add(new QuizItem(4, "8+2", new List<string>(){"7", "13", "0"}, "10")));
