        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<QuizItemEntity>()
                ...
                .UsingEntity(join => join.HasData(
                        ...
                        new { QuizItemsId = 5, IncorrectAnswersId = 13 },
                        // "2 * 8"
                        new { QuizItemsId = 6, IncorrectAnswersId = 10 },
                        new { QuizItemsId = 6, IncorrectAnswersId = 14 },
                        new { QuizItemsId = 6, IncorrectAnswersId = 7 },
                        // "2^3"
                        new { QuizItemsId = 7, IncorrectAnswersId = 13 },
                        new { QuizItemsId = 7, IncorrectAnswersId = 11 },
                        new { QuizItemsId = 7, IncorrectAnswersId = 10 },
                        // "8 * 5"
                        new { QuizItemsId = 8, IncorrectAnswersId = 12 },
